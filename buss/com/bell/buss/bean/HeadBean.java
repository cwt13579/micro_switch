...
public class HeadBean {
	...
	public String toString() {
		return "HeadBean [verNo=" + verNo + ", bankId=" + bankId
				+ ", sndChnlNo=" + sndChnlNo + ", rcvChnlNo=" + rcvChnlNo
				+ ", extTxnNo=" + extTxnNo + ", chnlDt=" + chnlDt + ", hostDt="
				+ hostDt + ", chnlTm=" + chnlTm + ", hostTm=" + hostTm
				+ ", chnlSeq=" + chnlSeq + ", hostSeq=" + hostSeq + ", rspNo="
				+ rspNo + ", rspMsg=" + rspMsg + "]";
	}
